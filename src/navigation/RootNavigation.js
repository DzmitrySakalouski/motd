...
export const RootNavigator = () => {
    return (
        <RootStack.Navigator screenOptions={appScreenOptions} initialRouteName='Main'>
            <RootStack.Screen name="Main" component={HomeDrawerNavigator} />
            <RootStack.Screen name="RecomendedMovieDetails" options={{presentation: 'modal'}} component={RecomendedMovieDetailsModal} />
        </RootStack.Navigator>
    )
}